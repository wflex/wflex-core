...
class Compat {
    ...
    public static function is(o:Any, clazz:Any){
        #if js
        return untyped __js__('{0} instanceof {1}', o, clazz);
        #else
        return Std.is(o, clazz);
        #end
    }
    ...
    public static function setProperty(o:Dynamic, propName:String, value) : Void
    {
        #if js
        untyped __js__('{0}[{1}] = {2}', o, propName, value);
        #else
        Reflect.setField(o, propName, value);
        #end
    }
